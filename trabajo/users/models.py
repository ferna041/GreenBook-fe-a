...
class CustomAccountManager(BaseUserManager):
    def create_user(self, email, nombre, ciudad, password, **other_fields):
    ...
    def create_superuser(self, email, nombre, ciudad, password, **other_fields):
        ...
        return self.create_user(email, nombre, ciudad, password, **other_fields)
